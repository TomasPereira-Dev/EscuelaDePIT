        ...
        <main className="flex flex-col gap-8 px-4 pb-16">
            ...
            <section className="flex flex-col justify-center gap-4">
                {list.length > 0 ? <>
                                    ...
                                    <span className={`${listIsOver ? "hidden" : "block"} underline self-center cursor-pointer hover:text-lightBlue1`} onClick={() => {setListLength(listLength + 25)}}>Ver más</span>
                                  </> 
