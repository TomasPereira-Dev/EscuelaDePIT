        ...
        <main className="flex flex-col items-center gap-4 px-4">
            ...
            <section className="my-8">
                <div className="flex flex-col items-center gap-4 lg:flex-row lg:gap-8">
                    <picture >
                        <source srcSet="./course-img-desktop.png" media="(min-width: 1024px)"/>
                    ...
                    <div className="flex flex-col items-center gap-2 lg:items-start">
                        ...
                        <h2 className="text-3xl text-text1 text-center lg:text-left">CURSO INTENSIVO DE P.I.T</h2>
                        <h3 className="text-lg text-text1 text-center lg:text-left">Capacitate con nosotros en esta revolucionaria terapia</h3>
                        <div>
                            <p className="text-text1 text-center lg:text-left">Duracion 12 semanas</p>
